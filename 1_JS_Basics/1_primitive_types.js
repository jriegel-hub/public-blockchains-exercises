...
if (luzernPopulation > randomNum) {
    console.log("Go Luzern");
}
else if (luzernPopulation === randomNum) {
...
finalStr = `${str1} Just like other ${luzernPopulation} persons in Luzern.`;  
console.log(finalStr); 
